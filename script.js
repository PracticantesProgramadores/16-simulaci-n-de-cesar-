...
function cambiarFondo(key) {
  canvas.classList.remove("bg-light","bg-white","bg-black","bg-dark","bg-blue","bg-yellow","bg-red","bg-green","bg-purple","bg-orange","bg-pink","bg-cyan","bg-teal","bg-gray","bg-gradient","bg-gradient-sunset","bg-gradient-ocean","bg-gradient-forest","bg-texture")
  const map = { white: "bg-white", black: "bg-black", blue: "bg-blue", yellow: "bg-yellow", red: "bg-red", green: "bg-green", purple: "bg-purple", orange: "bg-orange", pink: "bg-pink", cyan: "bg-cyan", teal: "bg-teal", gray: "bg-gray", gradient: "bg-gradient", gradientSunset: "bg-gradient-sunset", gradientOcean: "bg-gradient-ocean", gradientForest: "bg-gradient-forest", texture: "bg-texture" }
...
if (fontPreviewGrid) {
  const buttons = Array.from(fontPreviewGrid.querySelectorAll(".font-preview"))
  buttons.forEach(btn => {
    btn.style.fontFamily = btn.getAttribute("data-font")
    btn.addEventListener("click", () => {
      fontFamilySel.value = btn.getAttribute("data-font")
      aplicarPropiedades()
      buttons.forEach(b => b.classList.remove("active"))
      btn.classList.add("active")
    })
  })
  const current = buttons.find(b => b.getAttribute("data-font") === fontFamilySel.value)
...
fontFamilySel.addEventListener("change", () => {
  ...
  if (grid) grid.querySelectorAll(".font-preview").forEach(b => b.classList.toggle("active", b.getAttribute("data-font") === val))
})
